...
--------------------------------------------
local playBtn -- Creazione del bottone di inizio gioco


-- Ascoltatore del bottone (sulla pressione)
local function onPlayBtnRelease()
	-- Avvia il livello 1
	composer.gotoScene( "scene.gioco", "fade", 500 ) -- Transizione alla scena del gioco con sfocatura
	return true
...
function scene:create( event )
	...
	-- Creazione del logo NECESSITA LOGO
